...
from JustSECOND.src.second_net import SECONDNet
from JustSECOND.src.model_config import MODEL_CONFIG
...
def main():
    ...
    model = SECONDNet(model_cfg=MODEL_CONFIG)
    ...
    if args.ckpt is not None:
        ...
        if len(ckpt_list) > 0:
            ...
            it, start_epoch = model.load_params_with_optimizer(
                ckpt_list[-1], to_cpu=dist, optimizer=optimizer
            )
            last_epoch = start_epoch + 1
